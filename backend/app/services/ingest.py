...
class IngestService:
    ...
    def save_uploaded_file(
        ...
        document = Document(
            ...
            uploaded_by=user_id,
            collection_id=collection_id       # ← stored here
        )
    ...
    def process_document(self, document_id: str) -> Document:
        """
        Process a document: extract text, chunk, and store chunks in DB.
        Embedding happens separately via RAGService.embed_chunks().
        """
    ...
    def _extract_docx(self, file_path: str) -> Tuple[List[Dict], int]:
        ...
        page_count = max(1, len(total_text) // 3000)
    ...
    def _chunk_text(self, content: List[Dict], document_name: str) -> List[Dict]:
        """
    ...
    def _split_large_text(
        ...
        """Split text that is larger than chunk size."""
        chunks = []
    ...
    def get_documents(
        ...
        """Get paginated documents, optionally filtered by collection or user."""
